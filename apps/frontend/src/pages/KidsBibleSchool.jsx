      ...
      <div className="about-banner">
        <div className="container">
          ...
          <div className="breadcrumbs">
            ...
            <span style={{ color: '#333' }}>Kids Bible School</span>
          </div>
        </div>
      </div>
          ...
          <div className="row gy-5 align-items-center">
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <motion.div variants={fadeInUp} style={{ background: '#fef3c7', borderLeft: '4px solid #eab308', padding: '24px', borderRadius: '0 12px 12px 0', marginBottom: '30px' }}>
                  <h4 style={{ fontWeight: 800, color: '#92400e', marginBottom: '10px', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <ul style={{ listStyle: 'none', padding: 0, margin: 0, fontSize: '0.95rem', color: '#444', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    <li><strong>Morning Session:</strong> 9:30 AM – 10:30 AM (During HBR/Kothanur Service)</li>
                    <li><strong>Evening Session:</strong> 5:00 PM – 6:00 PM (During Kothanur Service)</li>
                    <li style={{ borderTop: '1px dashed #fcd34d', paddingTop: '8px', marginTop: '4px' }}>
            ...
            <div className="col-lg-6">
              ...
              >
                <SpotlightCard className="campus-card" spotlightColor="rgba(234, 179, 8, 0.08)" style={{ padding: '40px', border: '1px solid #eaeaea', borderRadius: '16px', background: '#fff' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '25px' }}>
                    <i className="bi bi-book-half" style={{ fontSize: '3rem', color: '#eab308' }}></i>
                    <span style={{ fontSize: '0.8rem', background: '#fef3c7', color: '#b45309', padding: '5px 14px', borderRadius: '20px', fontWeight: 700 }}>
                      Every Sunday
                    </span>
                  </div>

                  <h3 style={{ fontSize: '1.4rem', fontWeight: 800, color: '#1a1a1a', marginBottom: '20px' }}>Core Activities & Focus</h3>
                  ...
                  <div style={{ display: 'flex', gap: '15px' }}>
                    ...
                    <Link to="/gallery" className="btn-primary" style={{ flex: 1, textAlign: 'center', fontSize: '0.85rem', padding: '12px 0', background: 'linear-gradient(135deg, #bf953f 0%, #b38728 100%)', color: '#050609', border: 'none', borderRadius: '30px', fontWeight: 700, textDecoration: 'none' }}>
                      View Gallery
                    </Link>
                  </div>
                </SpotlightCard>
